...
ADD https://github.com/opentracing-contrib/nginx-opentracing/releases/download/v0.29.0/linux-amd64-nginx-1.23.4-ngx_http_module.so.tgz /etc/nginx/modules/opentracing.tgz
